...
class _league_database():
	...
	def set_player(self, account_id, data):
		...
		self.players[account_id] = data['wins']
		self.players[account_id] = data['losses']
		self.players[account_id] = data['name']
		self.players[account_id] = data['lp']
	...
	def set_champion(self, champion_key, data):
		...
		self.players[champion_key] = data['c_name']
		self.players[champion_key] = data['image']
	...
	def set_match_history(self, account_id, data):
		...
		self.players[account_id] = data['lane']
		self.players[account_id] = data['gameId']
		self.players[account_id] = data['champion']
		self.players[account_id] = data['queue']
		self.players[account_id] = data['role']
		self.players[account_id] = data['timestamp']
